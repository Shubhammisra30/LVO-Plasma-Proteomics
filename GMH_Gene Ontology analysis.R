...
###############################################################
# GO analysis of DAPs with FC 1.2 and p<0.05 in the GMH Cohort
###############################################################
...
write.csv(up.go.enrich.df, "Up_GO_Enrich_LVO_GMH.csv")
...
barplot(up.go.enrich, 
        drop = TRUE, 
        showCategory = 10, 
        title = "GO Pathways in Up Proteins- LVO vs. no LVO (GMH Cohort)",
        font.size = 8) + facet_grid(ONTOLOGY ~ ., scales="free")

#Dotplot
X11()
dotplot(up.go.enrich, title = "GO Pathways of Up Proteins- LVO vs. no LVO (GMH Cohort)", font.size = 8)
...
p <- dotplot(filtered_res, showCategory = length(go_list), title = "GO Pathways for Upregulated Proteins- LVO vs. no LVO (GMH Cohort)",
             font.size = 8)

# Save as PNG
ggsave(
  filename = "Concordant GO_Dotplot_Up Proteins_GMH.png",
  plot = p,
  width = 8,
  height = 6,
  dpi = 300
...
# Save as PDF
ggsave(
  filename = "Concordant GO_Dotplot_Up Proteins_GMH.pdf",
  plot = p,
  width = 8,
  height = 6
)
...
write.csv(down.go.enrich.df, "Down_GO_Enrich_LVO_GMH.csv")
...
barplot(down.go.enrich, 
        drop = TRUE, 
        showCategory = 10, 
        title = "GO Pathways in Down Proteins- LVO vs. no LVO (GMH Cohort)",
        font.size = 8) + facet_grid(ONTOLOGY ~ ., scales="free")

#Dotplot
X11()
dotplot(down.go.enrich, title = "GO Pathways in Down Proteins- LVO vs. no LVO (GMH Cohort)", font.size = 8)
...
p <- dotplot(filtered_res, showCategory = length(go_list), title = "GO Pathways for Downregulated Proteins- LVO vs. no LVO (GMH Cohort)",
             font.size = 8)

# Save as PNG
ggsave(
  filename = "Concordant GO_Dotplot_Down Proteins_GMH.png",
  plot = p,
  width = 8,
  height = 6,
  dpi = 300
...
# Save as PDF
ggsave(
  filename = "Concordant GO_Dotplot_Down Proteins_GMH.pdf",
  plot = p,
  width = 8,
  height = 6
)
